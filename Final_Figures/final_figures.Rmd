...
png('~/MRC_BSU_Internship_LDL/Final_Figures/interaction_manhattan.png',width = 1600,height = 600)
...
dev.off()
knitr::include_graphics('~/MRC_BSU_Internship_LDL/Final_Figures/interaction_manhattan.png')
...
png('~/MRC_BSU_Internship_LDL/Final_Figures/qq_plot.png',width = 600,height = 600)
qqman::qq(pvector = interaction_data_excl_hmgcr$p_int)
text(1,5,labels = bquote(lambda == .(lambda)))
dev.off()
knitr::include_graphics('~/MRC_BSU_Internship_LDL/Final_Figures/qq_plot.png')
```
...
```
```{r sd_plot}
source('~/MRC_BSU_Internship_LDL/Plots/CompareTreeSD.R')
